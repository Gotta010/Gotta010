...
module.exports = {
    ...
    BOT_INFO : process.env.BOT_INFO || "XKY.JACE_3.0;https://i.imgur.com/DyLAuEh.jpg",
    ...
    STICKER_DATA : process.env.STICKER_DATA || "XKY.JACE_3.0;XKY.JACE_3.0",
    BRAINSHOP: process.env.BRAINSHOP || '172372,nbjE0YAlyw3cpoMl',
    SUDO : process.env.SUDO || "50943468231",
